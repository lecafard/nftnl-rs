...
impl TProxy {
    /// Creates a new transparent proxy expression with a port register.
    ...
    /// Creates a new transparent proxy expression with an address register.
    ...
    /// Creates a new transparent proxy expression with an address register and a port register.
